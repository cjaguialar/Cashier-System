...
--
-- Host: 127.0.0.1
-- Generation Time: Feb 16, 2025 at 08:10 AM
...
--
ALTER TABLE `sales_items`
  ADD CONSTRAINT `sales_items_ibfk_1` FOREIGN KEY (`sale_id`) REFERENCES `sales_items` (`id`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `sales_items_ibfk_2` FOREIGN KEY (`product_id`) REFERENCES `sales_items` (`id`) ON DELETE CASCADE ON UPDATE CASCADE;
COMMIT;
